...
public class SchemaEnhancerQueries {
    ...
    public static final String FIND_PROPERTY_INSTANCE_COUNT = "SELECT ?property ?instances WHERE {SELECT DISTINCT ?property (COUNT(?x) as ?instances) WHERE {?x ?property []} GROUP BY ?property}";
