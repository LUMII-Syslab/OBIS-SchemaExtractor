...
public class Operation {
    ...
    /**
     * !!! OVERRIDDEN from original SpringFox code - 2.9.2 !!!
     * Ugly workaround for the defect with parameter ordering by position.
     * See details in - https://github.com/springfox/springfox/issues/2705
     * There is no simple and legal way to set ApiParam position, so used "Access" attribute to store position
     */
