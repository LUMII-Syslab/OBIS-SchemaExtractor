...
/**
 * !!!!!
 * OVERRIDE to overcome exception "Object key not recognized as valid for an RDF term: { }" for specific SPARQL endpoints
 * which do not follow W3C Recommendation
 * !!!!!
 * @TODO - review any other options to resolve the error without this ugly override
 */
@Slf4j
public class ResultSetReaderJSON implements ResultSetReader {
    ...
    static class RS_JSON {
        ...
        private void parse(InputStream in) {
            ...
            for ( ; iter.hasNext() ; ) {
                ...
                for ( String vn : varNames ) {
                    ...
                    if ( n != null ) { // OVERRIDE: check for null node
        ...
        private static Node parseOneTerm(JsonObject term, LabelToNode labelMap) {
            ...
            // OVERRIDE
            log.error("ResultSetException: Object key not recognized as valid for an RDF term: " + term);
            return null;
        }
